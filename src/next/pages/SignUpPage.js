...
export default function () {
  return(
    <div className={styles['full-height']}>
      <div className={`${styles['full-height']} d-flex flex-column flex-root`}>
        {/*begin::Login*/}
        <div
          className={`${styles['login']} ${styles['login-3']} ${styles['login-signin-on']} d-flex flex-column flex-lg-row flex-row-fluid bg-white`}
          id="kt_login"
        >
          {/*begin::Aside*/}
          <div
            className={`${styles['login-aside']} d-flex flex-row-auto bgi-size-cover bgi-no-repeat p-10 p-lg-10`}
          >
